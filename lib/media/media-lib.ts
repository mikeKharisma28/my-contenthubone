import MediaResult, { MediaGeneratedUploadLinks, MediaUpload } from '@/types/media-type';
...
export async function UploadMediaItems(paramBodyReq: MediaUpload[]): Promise<MediaResult[]> {
